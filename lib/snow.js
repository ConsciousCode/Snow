	...
	**/
	...
	Parser.prototype.parse_section=function parse_section(extra){
		...
		while(el--){
			var e=elems[el];
			if(typeof e=="string"){
				elems[i]=e.replace(/\\([^\\{\]])/g,function(m,$1){
					return $1;
				});
			}
		}
	...
	**/
	...
	if(typeof exports!='undefined'){
		if(typeof module!='undefined' && module.exports) {
			module.exports=new snow;
		}
		else{
			exports.snow = new snow;
		}
	}
	else if(root.snow=="undefined"){
		root.snow = new snow;
	}
	else{
		//Update a snow object with the snow object.
		//This is to allow snow modules and snow to be loaded in any order.
		var rsnow=root.snow;
		var s=root.snow=new snow;
		for(var x in rsnow){
			s[x]=rsnow[x];
		}
	}
